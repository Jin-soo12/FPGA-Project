...
HD_PWD='C:/Verilog work/Watch_Project/Watch_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Watch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Watch.tcl -notrace
