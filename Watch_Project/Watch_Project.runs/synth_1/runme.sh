...
HD_PWD='C:/Verilog work/Watch_Project/Watch_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Watch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Watch.tcl
