...
module watch_dp (
    ...
    watch_time_counter #(7, 100) U_MSEC (
        .clk(clk),
        .rst(rst),
        .i_tick(w_tick_100hz),
        .u_btn(u_btn),
    ...
    watch_time_counter #(5, 24) U_HOUR (
        .clk(clk),
        .rst(rst),
        .i_tick(w_tick_hour),
        .u_btn(u_btn),
